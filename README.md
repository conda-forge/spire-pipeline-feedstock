...
Once the `conda-forge` channel has been enabled, `spire-pipeline` can be installed with:

```
conda install spire-pipeline
```

It is possible to list all of the versions of `spire-pipeline` available on your platform with:
